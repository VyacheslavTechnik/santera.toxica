...
import { Code2, Bot, Brain, Settings } from "lucide-react";
      ...
      <div className="min-h-screen w-full px-4 sm:px-6 md:px-8 py-8 sm:py-10">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <TopicButton href="/topic/ai-coding" title="ИИ кодинг" description="Практика кода с моделями и Copilot" Icon={Code2} />
